...
║                                                                                                ║
║ <3 Playwright Team  
# FIX: Use xvfb-run to provide a virtual display screen for headed browsers
...
Error
Error: browserType.launch: Executable doesn't exist at /ms-playwright/chromium-1194/chrome-linux/chrome
...
run_playwright_tests:
  stage: "my-test-stage"
  # FIX: Upgraded image version from v1.49.0 to v1.56.1
  image: mcr.microsoft.com/playwright:v1.56.1-noble 
  script:


1. Update All Dependencies (Optional)
2. npm update

Update Browsers
npx playwright install

Update Playwright Package
npm install -D @playwright/test@latest

Check Current Version
npx playwright --version

4. grep command to run the test with the tag
