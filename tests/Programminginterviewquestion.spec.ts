...
test.describe("Coding questions", async () => {
  ...
  test("Sort string array in ascending and descending order", () => {
...
function sortStringArrayAscDescOrder() {
  ...
  const sortStringArrayAscOrder: string[] = items.sort((a, b) =>
    a.localeCompare(b),
  );

  console.log(
    `Sort string array in ascending order result: ${sortStringArrayAscOrder}`,
  );
  const sortStringArrayDescOrder: string[] = items.sort((a, b) =>
    b.localeCompare(a),
  );

  console.log(
    `Sort string array in descending order result: ${sortStringArrayDescOrder}`,
  );
}
